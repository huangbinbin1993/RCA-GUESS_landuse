...
/// $Date: 2015-04-28 16:48:02 +0200 (Tue, 28 Apr 2015) $
///
///////////////////////////////////////////////////////////////////////////////////////
...
void decayrates(double wcont,double gtemp_soil,double& k_soilfast,double& k_soilslow,
	...
	k_soilfast=k_soilfast10*gtemp_soil*moist_response/(double)date.ndayyear;
	k_soilslow=k_soilslow10*gtemp_soil*moist_response/(double)date.ndayyear;

	fr_litter=exp(-k_litter10*gtemp_soil*moist_response/(double)date.ndayyear);
...
/// Transfers litter from last year's growth, mortality and fire
...
void transfer_litter(Patch& patch) {
	...
	double lat = patch.stand.gridcell.get_lat();
...
void equilsom(Soil& soil) {
	...
	Climate& climate = soil.patch.stand.climate;
