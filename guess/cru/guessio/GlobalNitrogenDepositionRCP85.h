//////////////////////////////////////////////////////////////////////////////////////
// GLOBALNITROGENDEPOSITIONRCP85.H
// Header file for input from a fast data archive
// Created automatically by FastArchive on Mon Feb 13 16:40:56 2012
//
...
const int GLOBALNITROGENDEPOSITIONRCP85_DATA_LENGTH=1914;
...
public:
	...
	bool getnext(GlobalNitrogenDepositionRCP85& obj) {
		...
		for (i=131;i>=0;i--) obj.NOyWet[i]=popreal(pdata,GLOBALNITROGENDEPOSITIONRCP85_DATA_LENGTH,29,1e-005,0);
		for (i=131;i>=0;i--) obj.NOyDry[i]=popreal(pdata,GLOBALNITROGENDEPOSITIONRCP85_DATA_LENGTH,29,1e-005,0);
		for (i=131;i>=0;i--) obj.NHxWet[i]=popreal(pdata,GLOBALNITROGENDEPOSITIONRCP85_DATA_LENGTH,29,1e-005,0);
		for (i=131;i>=0;i--) obj.NHxDry[i]=popreal(pdata,GLOBALNITROGENDEPOSITIONRCP85_DATA_LENGTH,29,1e-005,0);
	...
	bool getindex(GlobalNitrogenDepositionRCP85& obj) {
		...
		bool not_done=true;
		long direction=1;
		long offset=GLOBALNITROGENDEPOSITIONRCP85_NRECORD/2+GLOBALNITROGENDEPOSITIONRCP85_NRECORD%2;
		long thisrecord=0-GLOBALNITROGENDEPOSITIONRCP85_NRECORD%2;

		while (not_done) {
			thisrecord+=offset*direction;
			if (thisrecord>=GLOBALNITROGENDEPOSITIONRCP85_NRECORD) thisrecord=GLOBALNITROGENDEPOSITIONRCP85_NRECORD-1;
