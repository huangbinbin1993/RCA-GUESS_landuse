...
Table out_eurofluxannual;
Table out_eurofluxmonthly_nee, out_eurofluxmonthly_aet, out_eurofluxmonthly_gpp;
Table out_eurofluxstats_nee, out_eurofluxstats_aet, out_eurofluxstats_gpp;
...
void initio(const xtring& insfilename) {
	...
	double precipm;
	double precipc;
	int isfluxdata[NFLUXYEARS]; // Flux data from 1996 to 2002
	double soildepth;
	int plantation_year;
	int num_dominant_species;
...
bool getgridcell(Gridcell& gridcell) {
	...
	if (gridlist.isobj) {
		...
		soilparameters(gridcell.soiltype,soilcode,gridlist.getobj().soildepth);
